...
# promedio de puntajes de las reviews
def calculate_average_score(movie_id: int,db:Session):    
    # Consulta para calcular el promedio de puntajes
    return db.query(func.avg(Review.score)).filter(Review.movie_id == movie_id).scalar()
